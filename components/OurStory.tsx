...
export function OurStory({ locale }: OurStoryProps) {
  ...
  return (
    <section className="relative py-16 md:py-32 overflow-hidden bg-gradient-to-b from-black via-emerald-950 to-black">
      {/* Background Elements */}
      ...
      <div className="relative max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="space-y-12 md:space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-48 md:h-80 bg-gradient-to-br from-green-900 to-emerald-900 rounded-2xl flex items-center justify-center overflow-hidden group">
